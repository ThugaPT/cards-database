...
const card: Card = {
	...
	effect: {
		en: "Draw 2 cards. If you drew any cards in this way, attach up to 2 Grass Energy cards from your hand to 1 of your Benched Pokémon.",
		fr: "Piochez 2 cartes. Si vous avez pioché des cartes de cette façon, attachez jusqu'à 2 cartes Énergie Grass de votre main à l'un de vos Pokémon de Banc.",
