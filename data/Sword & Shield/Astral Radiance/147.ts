...
const card: Card = {
	...
	effect: {
		en: "Search your deck for a Water Pokémon and an Item card, reveal them, and put them into your hand. Then, shuffle your deck.",
		fr: "Cherchez dans votre deck un Pokémon Water et une carte Objet, montrez-les, puis ajoutez-les à votre main. Mélangez ensuite votre deck.",
