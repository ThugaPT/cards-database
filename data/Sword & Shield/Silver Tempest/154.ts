...
const card: Card = {
	...
	name: {
		en: "Earthen Seal Stone",
		fr: "Pierre Scellée Terrestre",
		es: "Piedra Sello Terrestre",
		it: "Sigillo Terrestre",
		pt: "Pedra Selada Terrestre",
		de: "Erd-Siegelstein"
	},
	...
	effect: {
		en: "The Pokémon V this card is attached to can use the VSTAR Power on this card. (You still need the necessary Energy to use this attack.)",
		fr: "Le Pokémon-V auquel cette carte est attachée peut utiliser la Puissance VSTAR sur cette carte. (Vous avez toujours besoin de l'Énergie nécessaire pour utiliser cette attaque.)",
