...
const card: Card = {
	...
	name: {
		...
		fr: "Pierre Scellée Sylvestre",
		es: "Piedra Sello Forestal",
		it: "Sigillo Forestale",
		pt: "Pedra Selada Florestal",
		de: "Wald-Siegelstein"
	},
	...
	effect: {
		...
		fr: "Le Pokémon-V auquel cette carte est attachée peut utiliser la Puissance VSTAR sur cette carte.\nAlchimie Star\nPendant votre tour, vous pouvez chercher dans votre deck une carte et l'ajouter à votre main. Mélangez ensuite votre deck. (Vous ne pouvez utiliser qu'une Puissance VSTAR par partie.)",
