...
const card: Card = {
	...
	effect: {
		en: "Search your deck for up to 3 Dragon Pokémon, reveal them, and put them into your hand. Then, shuffle your deck.",
		fr: "Cherchez dans votre deck jusqu'à 3 Pokémon Dragon, montrez-les, puis ajoutez-les à votre main. Mélangez ensuite votre deck.",
