...
const card: Card = {
	...
	effect: {
		en: "The attacks of the Pokémon this card is attached to do 30 more damage to your opponent's Active Dragon Pokémon (before applying Weakness and Resistance).",
		fr: "Les attaques du Pokémon auquel cette carte est attachée infligent 30 dégâts supplémentaires au Pokémon Dragon Actif de votre adversaire (avant application de la Faiblesse et de la Résistance).",
