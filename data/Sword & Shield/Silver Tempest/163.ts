...
const card: Card = {
	...
	effect: {
		en: "You may use 4 Quad Stone cards at once.\n• If you used 1 card, heal 10 damage from your Active Pokémon.\n• If you used 4 cards, heal all damage from each of your Pokémon. (This effect works one time for 4 cards.)",
		fr: "Vous pouvez utiliser 4 cartes Quad Roc à la fois.\n• Si vous avez utilisé une carte, soignez 10 dégâts de votre Pokémon Actif.\n• Si vous avez utilisé 4 cartes, soignez tous les dégâts de chacun de vos Pokémon.\n(Cet effet agit une fois pour 4 cartes.)",
